...
const PricingSection = () => {
  const plans = [{
    ...
    features: ['Up to 2 plots', 'Max Area: 5 hectares', 'Essential weather alerts', 'Basic risk score calculation'],
    color: 'agri-green',
    ...
    features: ['Up to 15 plots', 'Max Area: 100 hectares', 'All Basic features', 'Weekly risk reports', 'Interactive dashboards', 'Urgent alerts (App / SMS / Email)', 'Detailed field reports (crop/soil/health)', 'Yield prediction', 'Historical comparison (3 years)'],
    color: 'sky-blue',
  ...
  return <section id="pricing" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          {plans.map((plan, index) => <Card key={index} className={`hover-lift bg-white border-2 transition-all duration-300 hover:shadow-xl relative ${plan.popular ? 'border-sky-blue scale-105' : 'border-gray-200 hover:border-agri-green'}`}>
              ...
              <CardContent className="space-y-6">
                ...
                <Button className={`w-full text-white ${plan.buttonColor} text-lg py-6`}>
                  Get Started
                </Button>
              </CardContent>
            </Card>)}
