      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Farmer Portfolio</span>
            </CardTitle>
            <CardDescription>RADI validation through documented farmer profiles</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Recent portfolio management updates</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-blue-50 transition-colors">
              ...
              <p className="text-xs text-gray-500">Add new profile</p>
            </button>
